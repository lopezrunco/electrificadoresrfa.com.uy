...
<head>
    ...
    <link rel="shortcut icon" href="/wp-content/themes/rfa-theme/assets/images/favicon.ico">
    <!-- FontAwesome CDN -->
...
<header class="fixed-top">
        ...
        <nav class="navbar bg-white navbar-expand-xl py-lg-0">
            <div class="container fade-in delay-level2">
                <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>">
                    <img class="main-logo" alt="Logo de RFA" src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" />
                </a>
                            ...
                            if ( $parent_category ) {
                                ...
                                if (! empty( $subcategories ) && ! is_wp_error( $subcategories )) {
                                    ...
                                    echo '<li class="nav-link dropdown">';
                                        echo '<a class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Productos</a>';
