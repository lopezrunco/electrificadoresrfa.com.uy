# Electrificadores RFA Wordpress theme

## Overview:

Electrificadores RFA Wordpress theme is a versatile and customizable theme designed specifically for agro companies. With a sleek design and user-friendly interface, it offers a seamless experience for both website administrators and visitors.
...
In the Wordpress administrator go to Appearence => Menus and in the top-right section click on the tab "Screen Options". In "Show advanced menu properties" check "Link Target" and "CSS Classes". Then go to the menu items and add the class "nav-link" in every one of them.
...
```json
[
    "email": "contacto@electrificadoresrfa.com.uy",
    "phones": ["099 653 702", "4352 31 37"],
